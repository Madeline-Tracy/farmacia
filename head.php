    ...
    <div class="navbar-fixed">
        <nav class="navbar-color">
            <div class="nav-wrapper">
                <ul class="left">                      
                  <li><h1 class="logo-wrapper"><a href="<?php echo $rutaLogo ?>" class="brand-logo darken-1"><img style="border-radius: 4px;" src="<?php echo $ruta ?>recursos/images/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">G & E</span></h1></li>
                </ul>

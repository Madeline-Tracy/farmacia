...
<body id="layouts-horizontal">
  ...
  function fn_agregarPRO(idproducto,iditemalamcen)
  {
    var canti= $("#"+idproducto+"cantidad").val();
  $.ajax({
      url: "validarCantidad.php",
      type: "POST",
      data: "iditem="+idproducto+"&cantidadMas="+canti+"&iditemalamcen="+iditemalamcen,
      success: function(resp){
        ...
        //alert(resp);
           if (resp==0) 
           {
              swal("ERROR !", "No existe la cantidad en el almacen", "warning");
           }
           if (resp==1) 
           {

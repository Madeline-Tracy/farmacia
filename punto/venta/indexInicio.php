                      ...
                      <div class="row">
                        <div class="col s12 m12 l12" style="background-color:#ffffff; border: 1px solid #D5D8DC; border-radius:5px;">
                          <div class="input-field col col s12 m6 estInEste"  style="font-weight:bold;">
                            <input id="idnit" name="idnit" type="text" class="validate" value="">
                            <label for="idnit">CI/NIT:</label>
                          </div>
                          <div class="input-field col col s12 m6 estInEste" style="font-weight:bold;">
                            <input id="idnombre" name="idnombre" type="text" class="validate" value="">
                          ...
                          <div class="campoForm col s12 m12 l6"  style="font-weight:bold;">
                            <div class="formAreaND"> 
                             <input id="idmontooriginal" name="idmontooriginal" type="text" readonly class="validate" value="0"> 
                              <div class="input-field col col s12 m6">
                                <input id="idmonto" name="idmonto" type="text" readonly class="validate" value="0">
                                <label for="idmonto">IMPORTE A PAGAR BS.</label>
                              </div>
                              <div class="input-field col col s12 m6">
                               <input id="iddescuento" name="iddescuento" type="text" class="validate" value="0">
                                <label for="iddescuento">Descuento (%)</label>
                              </div>
                              <div class="input-field col col s8 m8">
                                <input id="idimporte" name="idimporte" type="text" readonly class="validate" value="0">
                              ...
                              <div class="input-field col col s4 m4">
                                <input id="idimporteTar" name="idimporteTar" type="text" disabled class="validate" value="0">
                                <label for="idimporteTar">IMPORTE CON TARJETA BS.</label>
                              </div>
                              <div class="input-field col col s4 m4">
                                <input id="idnroreferencia" name="idnroreferencia" type="text" disabled class="validate" value="">
                              ...
                              <div class="input-field col col s12 m12">
                                <input id="idsaldo" name="idsaldo" type="text" readonly class="validate" value="0">
              ...
              <div class="col s12">
                ...
                <div class="col s12">
                  <div id="test1" class="col s12">
                    <?php
                      $consulta="SELECT ia.idalmacen, ia.iditem, ia.idlote, ia.cantidad_maxima, ia.cantidad_minima, ia.existencias, ia.precio_compraU, ia.precio_ventaU, ia.usuariocreacion, ia.fechacreacion, ia.horacreacion, ia.nombrehost,ia.activo
                                FROM item_almacen ia 
                                WHERE ia.activo=1 and ia.idalmacen=$idsucursal and ia.existencias>0 LIMIT $cantidad ";

                       foreach($item_almacen->sql($consulta) as $f)
                      //foreach($item_almacen->mostrarTodo("idalmacen=$idsucursal and existencias>0") as $f)//$idalm
                      {
                        $pro=$invitem->muestra($f['iditem']);  
                        ?> 
                          <div class="col s12 m12 l3 efecto" >
                            <div class="col s12 m12 l12">
                              <?php   
                                $df = $files->mostrarUltimo("id_publicacion = ".$f['iditem']." and tipo_foto = 'fotoItemInventarios'");
                                //echo count($datofoto);
                                if (count($df)==0){
                                  $pic= $ruta."imagenes/sinminiimagen.jpg";
                                }
                                else{
                                  $pic= $ruta."inventarios/item/editar/server/php/".$f['iditem']."/".$df['name'];
                                  //echo $pic;
                                }
                              ?>
                              <img style="width: 120px;" class="imgefecto" onclick="fn_agregarPRO('<?php echo $f["iditem"] ;?>','<?php echo $pro['nombre'] ;?>','<?php echo $pro['precio'] ;?>','MASVENDIDOS');" src="<?php echo $pic ?>">
                            </div>   
                            <div class="col s12 m6 l8 precio">
                              <label style=" ">Bs</label><label class="preN"><?php echo $pro['precio']; ?></label>
                            </div>
                          ...
                          ?>                              
                            <tr>
                              ...
                              ?>
                               ...
                               <td style="width: 50px;">
                              <input style="text-align:center; font-size:20px; color:green" id="<?php echo $f['iditem'].'cantidad' ?>" name="<?php echo $f['iditem'].'cantidad' ?>" type='number' value="1">
                              </td>                           
                              <td style="width: 43px;">
                              <?php
                                echo $f['existencias'];
                              ...
                              <td width="90px;">
                              <button class="btn-jh green" onclick="fn_agregarPRO('<?php echo $f["iditem"] ;?>','<?php echo $pro['nombre'] ;?>','<?php echo $pro['precio'] ;?>','GENERAL');"><i class="fa fa-plus"></i>Adicionar</button> 
                               </td>
                            </tr>
                          <?php
                          }
...
var table;
      ...
      function fn_agregarPRO(idproducto,producto,precio,tipo)
      {
        if (tipo=='MASVENDIDOS') 
        {
             var canti= 1;
        ...
        var str="idproducto="+idproducto+"&idprecio="+precio+"&idnombreProd="+producto+"&idcantidad="+canti;
        $("#examples").dataTable().fnDestroy();
        var table=$("#examples").dataTable({
          "ajax":{
            "method":"POST",

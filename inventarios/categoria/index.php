    ...
    <div id="main">
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div class="container">
            <div class="section">
              <a href="nuevo/" class="btn blue"><i class="fa fa-plus"></i> Nueva Categoría</a><br><br>
              <div class="col s12 m12 l6">
                <table id="example" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    {
                      $lblcode=ecUrl($f['idinvcategoria']);
                    ?>
                    <tr>
                      <td><?php echo $f['nombre'] ?></td>
                      <td style="width: 60%"><?php echo $f['descripcion'] ?></td>
